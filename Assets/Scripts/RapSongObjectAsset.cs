...
public class RapSongObjectAsset {
	...
	*/
	...
	[MenuItem("Assets/Create/RapSongObject")]
	public static void CreateAsset ()
	{
		CustomAssetUtility.CreateAsset<RapSongObject>(true); //Dialogue which is a scriptable object allow us to create an instance of it which does not need to be attached to gameobject / is not a monobehaviour
	}
}
#endif
